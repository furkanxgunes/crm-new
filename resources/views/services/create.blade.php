                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{ route('services.store') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="base_price" class="block mt-1 w-full" type="number" step="0.01" name="base_price" required />
                        </div>
                        ...
                        <div class="mt-4">
                         ...
                         <div class="mt-4">
                            ...
                            <textarea name="description" id="description" rows="4" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"></textarea>
                        </div>
